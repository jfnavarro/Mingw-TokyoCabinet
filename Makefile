...
CC = gcc
CPPFLAGS = -I. -I$(INCLUDEDIR) -I/scratch/newhome/include -I/usr/local/include -DNDEBUG -D_GNU_SOURCE=1 -D_REENTRANT -D__EXTENSIONS__ \
...
LDFLAGS = -L. -L$(LIBDIR) -L/scratch/newhome/lib -L/usr/local/lib
CMDLDFLAGS = 
